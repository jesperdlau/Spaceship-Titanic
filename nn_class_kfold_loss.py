...
save_path = "Spaceship-Titanic/Data/nn_class_pred_loss.npy"
k_folds = 5
#test_size= 0.1
batch_size = 5
batch_size_outer = 1
        ...
        for hyper in range(hyper_range):
            ...
            for epoch in range(epochs):
                ...
                if test_loss < best_hyper_loss:
                    best_hyper_loss, best_hyper_acc = test_loss, test_acc
            ...
            print(f"[{outer_layer+1}/{k_folds}:{inner_layer+1}/{k_folds}:{hyper+1}/{hyper_range}: {best_hyper_acc:.4f}%]")
